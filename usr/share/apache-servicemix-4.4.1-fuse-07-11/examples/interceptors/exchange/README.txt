...
exchange-1.5.1-fuse-06-11.jar, in the target directory of this
example.
...
- Using Hot Deployment
  ...
  Copy the target/exchange-1.5.1-fuse-06-11.zip to the 
...
- Using the ServiceMix Console
  ...
  Enter the following command:
   ...
   osgi:install -s mvn:org.apache.servicemix.nmr.examples.interceptors/exchange/1.5.1-fuse-06-11/jar
